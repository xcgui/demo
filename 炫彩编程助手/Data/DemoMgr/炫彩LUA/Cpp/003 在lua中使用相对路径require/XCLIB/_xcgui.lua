...
function XC_InitLua()
return XC_API_CALL('XC_InitLua');
end

function XC_RunLua(pLuaFile)
return XC_API_CALL('XC_RunLua',pLuaFile);
end

function XC_ExitLua()
return XC_API_CALL('XC_ExitLua');
end
...
function XC_SetProperty(hXCGUI,pName,pValue)
return XC_API_CALL('XC_SetProperty',hXCGUI,pName,pValue);
end

function XC_GetProperty(hXCGUI,pName)
return XC_API_CALL('XC_GetProperty',hXCGUI,pName);
end
...
function XC_GetObjectByUID(nUID)
return XC_API_CALL('XC_GetObjectByUID',nUID);
end

function XC_GetObjectByUIDName(pName)
return XC_API_CALL('XC_GetObjectByUIDName',pName);
end
...
function XC_GetResImageEx(pFileName,pName)
return XC_API_CALL('XC_GetResImageEx',pFileName,pName);
end

function XC_GetResColor(pName)
return XC_API_CALL('XC_GetResColor',pName);
end

function XC_GetResFont(pName)
return XC_API_CALL('XC_GetResFont',pName);
end

function XC_GetResBkInfoM(pName)
return XC_API_CALL('XC_GetResBkInfoM',pName);
end
...
function XC_LoadStyle(pFileName,pDir)
return XC_API_CALL('XC_LoadStyle',pFileName,pDir);
end
...
function XObj_GetType(hXCGUI)
return XC_API_CALL('XObj_GetType',hXCGUI);
end

function XObj_GetTypeEx(hXCGUI)
return XC_API_CALL('XObj_GetTypeEx',hXCGUI);
end

function XUI_SetStyle(hXCGUI,nStyle)
return XC_API_CALL('XUI_SetStyle',hXCGUI,nStyle);
end

function XUI_GetStyle(hXCGUI)
return XC_API_CALL('XUI_GetStyle',hXCGUI);
end
...
function XBkInfoM_AddInfo(hBkInfoM,pText)
return XC_API_CALL('XBkInfoM_AddInfo',hBkInfoM,pText);
end
...
function XBtn_GetIcon(hEle,nType)
return XC_API_CALL('XBtn_GetIcon',hEle,nType);
end
...
function XComboBox_EnableDropHeightFixed(hEle,bEnable)
return XC_API_CALL('XComboBox_EnableDropHeightFixed',hEle,bEnable);
end
...
function XDraw_SetClipRect(hDraw,pRect)
return XC_API_CALL('XDraw_SetClipRect',hDraw,pRect);
end

function XDraw_ClearClip(hDraw)
return XC_API_CALL('XDraw_ClearClip',hDraw);
end
...
function XDraw_FillRoundRectEx(hDraw,pRect,nLeftTop,nRightTop,nRightBottom,nLeftBottom)
return XC_API_CALL('XDraw_FillRoundRectEx',hDraw,pRect,nLeftTop,nRightTop,nRightBottom,nLeftBottom);
end

function XDraw_DrawRoundRectEx(hDraw,pRect,nLeftTop,nRightTop,nRightBottom,nLeftBottom)
return XC_API_CALL('XDraw_DrawRoundRectEx',hDraw,pRect,nLeftTop,nRightTop,nRightBottom,nLeftBottom);
end
...
function _XEle_RegEvent(hEle,nEvent,pEvent)
return XC_API_CALL('_XEle_RegEvent',hEle,nEvent,pEvent);
end

function _XEle_RemoveEvent(hEle,nEvent,pEvent)
return XC_API_CALL('_XEle_RemoveEvent',hEle,nEvent,pEvent);
end
...
function XEle_EnableCSS(hEle,bEnable)
return XC_API_CALL('XEle_EnableCSS',hEle,bEnable);
end

function XEle_SetCssName(hEle,pName)
return XC_API_CALL('XEle_SetCssName',hEle,pName);
end

function XEle_GetCssName(hEle)
return XC_API_CALL('XEle_GetCssName',hEle);
end
...
function XEle_SetID(hEle,nID)
return XC_API_CALL('XEle_SetID',hEle,nID);
end
...
function XEle_SetUID(hEle,nUID)
return XC_API_CALL('XEle_SetUID',hEle,nUID);
end

function XEle_GetUID(hEle)
return XC_API_CALL('XEle_GetUID',hEle);
end
...
function XEle_GetChildByID(hEle,nID)
return XC_API_CALL('XEle_GetChildByID',hEle,nID);
end
...
function XEle_DrawEle(hEle,hDraw)
return XC_API_CALL('XEle_DrawEle',hEle,hDraw);
end
...
function XEle_PopupToolTip(hEle,x,y)
return XC_API_CALL('XEle_PopupToolTip',hEle,x,y);
end
...
function XLayout_SetUID(hLayout,nUID)
return XC_API_CALL('XLayout_SetUID',hLayout,nUID);
end

function XLayout_GetUID(hLayout)
return XC_API_CALL('XLayout_GetUID',hLayout);
end
...
function XListBox_CreateAdapter(hEle)
return XC_API_CALL('XListBox_CreateAdapter',hEle);
end
...
function XListBox_RefreshItem(hEle,iItem)
return XC_API_CALL('XListBox_RefreshItem',hEle,iItem);
end
...
function XList_SetSelectItem(hEle,iItem)
return XC_API_CALL('XList_SetSelectItem',hEle,iItem);
end
...
function XList_CreateAdapter(hEle)
return XC_API_CALL('XList_CreateAdapter',hEle);
end

function XList_CreateAdapterHeader(hEle)
return XC_API_CALL('XList_CreateAdapterHeader',hEle);
end
...
function XList_GetAdapterHeader(hEle)
return XC_API_CALL('XList_GetAdapterHeader',hEle);
end
...
function XList_RefreshItem(hEle,iItem)
return XC_API_CALL('XList_RefreshItem',hEle,iItem);
end
...
function XListView_CreateAdapter(hEle)
return XC_API_CALL('XListView_CreateAdapter',hEle);
end
...
function XListView_RefreshItem(hEle,iGroup,iItem)
return XC_API_CALL('XListView_RefreshItem',hEle,iGroup,iItem);
end
...
function XPane_GetViewRect(hEle,pRect)
return XC_API_CALL('XPane_GetViewRect',hEle,pRect);
end
...
function XPGrid_SetItemData(hEle,nItemID,nUserData)
return XC_API_CALL('XPGrid_SetItemData',hEle,nItemID,nUserData);
end

function XPGrid_GetItemData(hEle,nItemID)
return XC_API_CALL('XPGrid_GetItemData',hEle,nItemID);
end
...
function XPGrid_SetDrawItemBkFlags(hEle,nFlags)
return XC_API_CALL('XPGrid_SetDrawItemBkFlags',hEle,nFlags);
end
...
function XRichEdit_EnableVerticalCenter(hEle,bEnable)
return XC_API_CALL('XRichEdit_EnableVerticalCenter',hEle,bEnable);
end
...
function XSBar_SetSliderPadding(hEle,nPadding)
return XC_API_CALL('XSBar_SetSliderPadding',hEle,nPadding);
end
...
function XShape_SetUID(hShape,nUID)
return XC_API_CALL('XShape_SetUID',hShape,nUID);
end

function XShape_GetUID(hShape)
return XC_API_CALL('XShape_GetUID',hShape);
end
...
function XShapeText_EnableCSS(hTextBlock,bEnable)
return XC_API_CALL('XShapeText_EnableCSS',hTextBlock,bEnable);
end

function XShapeText_SetCssName(hTextBlock,pName)
return XC_API_CALL('XShapeText_SetCssName',hTextBlock,pName);
end

function XShapeText_GetCssName(hTextBlock)
return XC_API_CALL('XShapeText_GetCssName',hTextBlock);
end
...
function XTabBar_SetPadding(hEle,left,top,right,bottom)
return XC_API_CALL('XTabBar_SetPadding',hEle,left,top,right,bottom);
end
...
function XToolBar_InsertSeparator(hEle,index,color)
return XC_API_CALL('XToolBar_InsertSeparator',hEle,index,color);
end
...
function XTree_EnableExpand(hEle,bEnable)
return XC_API_CALL('XTree_EnableExpand',hEle,bEnable);
end
...
function XTree_SetConnectLineLength(hEle,nLength)
return XC_API_CALL('XTree_SetConnectLineLength',hEle,nLength);
end
...
function XTree_CreateAdapter(hEle)
return XC_API_CALL('XTree_CreateAdapter',hEle);
end
...
function XTree_RefreshItem(hEle,nID)
return XC_API_CALL('XTree_RefreshItem',hEle,nID);
end

function _XWnd_RegEvent(hWindow,nEvent,pEvent)
return XC_API_CALL('_XWnd_RegEvent',hWindow,nEvent,pEvent);
end

function _XWnd_RemoveEvent(hWindow,nEvent,pEvent)
return XC_API_CALL('_XWnd_RemoveEvent',hWindow,nEvent,pEvent);
end
...
function XWnd_RemoveEventC(hWindow,nEvent,pFun)
return XC_API_CALL('XWnd_RemoveEventC',hWindow,nEvent,pFun);
end
...
function XWnd_DrawWindow(hWindow,hDraw)
return XC_API_CALL('XWnd_DrawWindow',hWindow,hDraw);
end
...
function XWnd_SetTextColor(hWindow,color,alpha)
return XC_API_CALL('XWnd_SetTextColor',hWindow,color,alpha);
end

function XWnd_GetTextColor(hWindow)
return XC_API_CALL('XWnd_GetTextColor',hWindow);
end
...
function XWnd_EnableCSS(hWindow,bEnable)
return XC_API_CALL('XWnd_EnableCSS',hWindow,bEnable);
end

function XWnd_SetCssName(hWindow,pName)
return XC_API_CALL('XWnd_SetCssName',hWindow,pName);
end

function XWnd_GetCssName(hWindow)
return XC_API_CALL('XWnd_GetCssName',hWindow);
end
