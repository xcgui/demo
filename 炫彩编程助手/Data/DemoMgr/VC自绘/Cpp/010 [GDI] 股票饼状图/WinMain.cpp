...
public:
	...
	int OnDraw(HDRAW hDraw,BOOL *pbHandled)
	{
		...
		TestPieSix(&XDrawDc,&XGdiDC,&GdiplusDC);
		
		return 0;
	}

	void TestPieSix(XDCDraw* pXDrawDC,XDCGDI* pXGdiDC,XDCGDIPlus* pGdiPlusDC)
	{
		XGDIPieSix bintu;
		bintu.Create(0,0,100,100);
		bintu.Draw(pXGdiDC,1618,1832,1354,838,1212,1328);	
	}
