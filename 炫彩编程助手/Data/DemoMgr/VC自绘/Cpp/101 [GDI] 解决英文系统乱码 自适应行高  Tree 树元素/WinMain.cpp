...
public:
	...
	{
		m_GdiFont.CreateFromFile(L"simsun.ttc",L"宋体",12);
		m_MemDc.Create(XEle_GetHWND(hParent));
		m_MemDc.SelectObject(m_GdiFont.GetHFont());
		m_TextColor= 0;
	}
...
public:
    ...
    void Init()
    {
        ...
        XBtn_SetType(XBtn_Create(5, 3, 60, 20, L"关闭", m_hWindow),button_type_close);
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	SetThreadLocale(
		MAKELCID(
		MAKELANGID(LANG_CHINESE,SUBLANG_CHINESE_SIMPLIFIED),SORT_CHINESE_PRC)
		);
