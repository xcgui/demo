...
//                           UINT nFlags,POINT *pPt,BOOL *pbHandled
function OnWndLButtonDown(nFlags:Integer;pPt:TPOINT;pbHandle:PBoolean):Integer;stdcall;
begin
    MessageBox(0,'窗口左键按下','提示',MB_OK);
    Result := 0;
end;
...
begin
       ...
       XWnd_RegEventC(hWindow,WM_LBUTTONDOWN,Integer(@OnWndLButtonDown));
