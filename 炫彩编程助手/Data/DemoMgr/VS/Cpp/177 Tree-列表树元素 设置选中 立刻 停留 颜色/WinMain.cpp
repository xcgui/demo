...
public:
    ...
    void Init()
    {
		...
		//设置项选中未选中颜色等
		HBKM hBkM = XEle_GetBkManager(m_hTree);
		XBkM_AddFill(hBkM,tree_state_flag_item_leave,RGB(255,0,0),255);
		XBkM_AddFill(hBkM,tree_state_flag_item_stay,RGB(0,255,0),255);
		XBkM_AddFill(hBkM,tree_state_flag_item_select,RGB(0,0,255),255);
