...
public:
    ...
    void Init()
    {
		...
		//因为窗口比较小，所以可能看不到，看效果请拖动窗口大小
//		HELE hView = XEle_Create(200,10,100,100,m_hWindow);
		HELE hView = (HELE)XC_LoadLayout(L"xml\\View.xml",m_hWindow);
		...
		HELE hStartPage = (HELE)XC_LoadLayout(L"xml\\起始页.xml",m_hPane5);
		XPane_SetView(m_hPane5,hStartPage);
		//XPane_Create()
